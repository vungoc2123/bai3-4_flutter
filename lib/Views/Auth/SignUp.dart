...
import '../../Repository/Auth_Firebase.dart';
          ...
          body: SingleChildScrollView(
            child: SizedBox(
              ...
              child: Stack(
                children: [
                  Container(
                      decoration: const BoxDecoration(color: Color(0xFF4880FF))),
                  Positioned(
                      child: Row(
                    children: [
                      IconButton(
                    ...
                    child: Container(
                      ...
                      decoration: const BoxDecoration(
                          ...
                          borderRadius: BorderRadius.only(
                            topLeft: Radius.circular(20.0), // Bo góc bên trái trên
          ...
          return Column(
            children: [
              ReactiveTextField<String>(
                ...
                onChanged: (value){
                  form.valid ? ref.read(checkFormProvider.notifier).state = true : ref.read(checkFormProvider.notifier).state= false;
                },
              ...
              ReactiveTextField<String>(
                ...
                obscureText: true,
                validationMessages: {
                  'required': (error) => 'The confirm password must not be empty'
                },
              ),
              Container(
                    ...
                    onPressed:check ? () async {
                      if (form.valid) {
                        auth
                            ...
                            context,
                            Account(form.control('email').value,
                                form.control('password').value))
                            .then((value) => {
                          if (value == true) {_showMyDialog(context)}
                        });
                      }
                    }: null,
                    child: const Text(
